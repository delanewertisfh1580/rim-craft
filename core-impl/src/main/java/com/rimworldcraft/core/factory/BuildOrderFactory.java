...
public final class BuildOrderFactory {
    ...
    public BuildOrder createFromGhostBlock(GhostBlock ghostBlock) { return new BuildOrder(ghostBlock.buildOrderId(), UUID.randomUUID(), ghostBlock.blockType(), ghostBlock.position(), 5, java.util.Map.of()); }
}
